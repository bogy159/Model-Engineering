...
/**
 * This is the item provider adapter for a {@link roverml.Move} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MoveItemProvider extends CommandItemProvider {
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						RovermlPackage.Literals.MOVE__LENGTH, true, false, false,
	...
	protected void addVelocityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						RovermlPackage.Literals.MOVE__VELOCITY, true, false, false,
						ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RovermlPackage.Literals.MOVE__VELOCITY_UNITS);
			childrenFeatures.add(RovermlPackage.Literals.MOVE__LENGTH_UNITS);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Move_type") + " " + move.getLength();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RovermlPackage.Literals.MOVE__VELOCITY_UNITS,
				RovermlFactory.eINSTANCE.createVelocity()));

		newChildDescriptors.add(createChildParameter(RovermlPackage.Literals.MOVE__LENGTH_UNITS,
