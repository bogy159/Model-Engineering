...
/**
 * This is the item provider adapter for a {@link roverml.Block} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RovermlPackage.Literals.BLOCK__TRANSITIONS,
				RovermlFactory.eINSTANCE.createTransition()));

		newChildDescriptors.add(createChildParameter(RovermlPackage.Literals.BLOCK__TRANSITIONS,
				RovermlFactory.eINSTANCE.createTriggered()));

		newChildDescriptors.add(createChildParameter(RovermlPackage.Literals.BLOCK__TRANSITIONS,
				RovermlFactory.eINSTANCE.createRegular()));
		...
		newChildDescriptors.add(createChildParameter(RovermlPackage.Literals.BLOCK__COMMANDS,
		...
		newChildDescriptors.add(
				createChildParameter(RovermlPackage.Literals.BLOCK__COMMANDS, RovermlFactory.eINSTANCE.createWait()));

		newChildDescriptors.add(
				createChildParameter(RovermlPackage.Literals.BLOCK__COMMANDS, RovermlFactory.eINSTANCE.createMove()));

		newChildDescriptors.add(
				createChildParameter(RovermlPackage.Literals.BLOCK__COMMANDS, RovermlFactory.eINSTANCE.createRotate()));

		newChildDescriptors.add(createChildParameter(RovermlPackage.Literals.BLOCK__COMMANDS,
				RovermlFactory.eINSTANCE.createTerminate()));

		newChildDescriptors.add(
				createChildParameter(RovermlPackage.Literals.BLOCK__COMMANDS, RovermlFactory.eINSTANCE.createRepeat()));
	}
