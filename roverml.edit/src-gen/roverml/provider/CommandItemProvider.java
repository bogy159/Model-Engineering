...
/**
 * This is the item provider adapter for a {@link roverml.Command} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommandItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addOutgoingTransitionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Command_outgoingTransitions_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Command_outgoingTransitions_feature",
								"_UI_Command_type"),
						RovermlPackage.Literals.COMMAND__OUTGOING_TRANSITIONS, true, false, true, null, null, null));
	}
	...
	protected void addIncomingTransitionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Command_incomingTransitions_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Command_incomingTransitions_feature",
								"_UI_Command_type"),
						RovermlPackage.Literals.COMMAND__INCOMING_TRANSITIONS, true, false, true, null, null, null));
	}
	...
	protected void addComponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Command_components_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Command_components_feature",
								"_UI_Command_type"),
						RovermlPackage.Literals.COMMAND__COMPONENTS, true, false, true, null, null, null));
	}
