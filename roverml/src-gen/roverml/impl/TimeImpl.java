 ...
 * </p>
 * <ul>
 *   <li>{@link roverml.impl.TimeImpl#getUnits <em>Units</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeImpl extends SingleQuantityImpl implements Time {
	 ...
	 * @ordered
	 */
	protected static final TimeUnits UNITS_EDEFAULT = TimeUnits.NANOSECONDS;
	...
	public void setUnits(TimeUnits newUnits) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RovermlPackage.TIME__UNITS, oldUnits, units));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RovermlPackage.TIME__UNITS:
			return getUnits();
		}
